...
description: >
  Create new agents in Synaptica with governance-aware hiring. Use when you need
...
2. Discover available adapter configuration docs for this Synaptica instance.
